          ...
          <LinearGradientText
            text={
              <Text category="h1" marginBottom={4}>
                Geben Sie den Klassen-Code ein
              </Text>
            }
          />
          <Text status="placeholder" category="body">
            Ihr Lehrer wird den Code an registrierte Schüler weitergeben
          </Text>
          <Input placeholder="00000" style={styles.input} />
        </VStack>
      </KeyboardAwareScrollView>
      <VStack mh={16}>
        <Button
          children={"Weitermachen"}
          style={styles.button}
          onPress={() => {
